...
---
Os padrões de Casa Passiva (PH) evoluíram significativamente desde sua criação pelo Instituto de Casa Passiva (PHI) em Darmstadt, Alemanha. O que começou como um modelo único e claro se expandiu para um conjunto diversificado de classes de desempenho adaptadas a diferentes climas, tipos de edifícios e fontes de energia. Essa evolução reflete a crescente complexidade e ambição do design de edifícios de baixo consumo de energia, enquanto preserva os objetivos fundamentais de estanqueidade, conforto térmico e eficiência energética.
